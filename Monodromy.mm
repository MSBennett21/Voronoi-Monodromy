...
Monodromy := proc(f, x, y, val1 :: posint := 10, showpath := true )
	...
	#local vars
		n := algcurves[genus](f, x, y), a_n, X, Y, disc, j, problemPts := {}, problemPtsFloat := {}, auxSet1 :={},  auxSet2 := {}, N, centerOfData, r, boundarySites := {}, minimalDist, val2 := 1, aux_fun1, data, tempCell, edgeData := {}, indexer := 0, A; 
...
$include "Voronoi-Monodromy\Intersections.mm"
	...
	problemPts := allvalues~( { solve( disc=0 ) } );
